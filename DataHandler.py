...
class RNNDataHandler:
    ...
    def init_user_times(self):
        ...
        # add gap-times based on first timestamp in new session and the last timestamp in the last session gaps that
        # are less than provided minimum threshold indicate that the two sessions involved originally was a single
        # session, thus the gap should be ignored
    ...
    def get_next_batch(self, dataset, dataset_session_lengths, time_set):
        ...
        # TODO: difference between sess_time_rep and time_targets
        # TODO: Context representations?
